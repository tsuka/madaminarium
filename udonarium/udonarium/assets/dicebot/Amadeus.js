...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $Amadeus_initialize$1, $Amadeus_rollDiceCommand$2, $Amadeus_amadeusDice$3, $Amadeus_check_success$6;
    ...
    Opal.def(self, '$initialize', $Amadeus_initialize$1 = function $$initialize() {
      var $iter = $Amadeus_initialize$1.$$p, $yield = $iter || nil, self = this, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;
      ...
      $send(self, Opal.find_super_dispatcher(self, 'initialize', $Amadeus_initialize$1, false), $zuper, $iter);
      self.sendMode = 2;
      self.sortType = 1;
      return (self.d66Type = 2);
    }, $Amadeus_initialize$1.$$arity = 0);
    
    Opal.def(self, '$rollDiceCommand', $Amadeus_rollDiceCommand$2 = function $$rollDiceCommand(command) {
    ...
    }, $Amadeus_rollDiceCommand$2.$$arity = 1);
    ...
    Opal.def(self, '$check_success', $Amadeus_check_success$6 = function $$check_success(total_n, dice_n, signOfInequality, diff, special_n) {
