...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $DoubleCross_Korean_check_nD10$16, $DoubleCross_Korean_rollDiceCommand$17, $DoubleCross_Korean_parse_dx$18, $DoubleCross_Korean_parse_dx_od$19, $DoubleCross_Korean_parse_dx_shippu_doto$20, $DoubleCross_Korean_roll_emotion_table$21;
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.def(self, '$execute', $DX_execute$2 = function $$execute(bot) {
        ...
        if ($truthy($rb_lt(self.critical_value, 2))) {
          return "" + "(" + (self.expression) + ") ＞ 크리티컬치가 너무 낮습니다. 2 이상을 지정해주세요."};
        if ($truthy($rb_lt(self.num, 1))) {
          return "" + "(" + (self.expression) + ") ＞ 자동실패"};
        value_groups = [];
    ...
    Opal.def(self, '$check_nD10', $DoubleCross_Korean_check_nD10$16 = function $$check_nD10(total, _dice_total, dice_list, cmp_op, target) {
      var self = this;
    ...
    }, $DoubleCross_Korean_check_nD10$16.$$arity = 5);
    
    Opal.def(self, '$rollDiceCommand', $DoubleCross_Korean_rollDiceCommand$17 = function $$rollDiceCommand(command) {
      ...
      return nil;
    }, $DoubleCross_Korean_rollDiceCommand$17.$$arity = 1);
    self.$private();
    ...
    Opal.def(self, '$parse_dx', $DoubleCross_Korean_parse_dx$18 = function $$parse_dx(command) {
      var self = this, $case = nil;
      ...
      return nil;
    }, $DoubleCross_Korean_parse_dx$18.$$arity = 1);
    
    Opal.def(self, '$parse_dx_od', $DoubleCross_Korean_parse_dx_od$19 = function $$parse_dx_od(m) {
    ...
    }, $DoubleCross_Korean_parse_dx_od$19.$$arity = 1);
    
    Opal.def(self, '$parse_dx_shippu_doto', $DoubleCross_Korean_parse_dx_shippu_doto$20 = function $$parse_dx_shippu_doto(m) {
      ...
      target_value = ($truthy($a = m['$[]'](4)) ? m['$[]'](4).$to_i() : $a);
      return $$($nesting, 'DX').$new(num, critical_value, modifier, target_value);
    }, $DoubleCross_Korean_parse_dx_shippu_doto$20.$$arity = 1);
    
    Opal.def(self, '$roll_emotion_table', $DoubleCross_Korean_roll_emotion_table$21 = function $$roll_emotion_table() {
